<ul class="navbar-nav">
    <li role="presentation" class="nav-item nav-link active"><a ref="index.php?page=1">Home</a></li>
    <li role="presentation" class="nav-item nav-link"><a href="index.php?page=2">Upload</a></li>
